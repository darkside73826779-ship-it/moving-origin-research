...
| M4 final pre-scoring crash cart | Beta; implementation authorized | The corrected design closes BF1–BF4 and is authorized for exact implementation with warmup, staged fail-closed reports, separate structural/replica axes, and explicit provenance. | v0.1-alpha remains blocked. Beta is not implemented, runnable, released, scored, or promoted to v1; execution requires a later explicit decision. | [Final delta rereview](https://github.com/darkside73826779-ship-it/moving-origin-research/blob/76b6b99444f0ecf0f085681c6eddb454f8cf2a60/reviews/critic_m4_final_prescoring_crash_cart_bf1_bf4_rereview.md) |
