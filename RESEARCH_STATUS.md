...
| M4 final pre-scoring crash cart | v0.2-alpha COMBINED CLEAR; not promoted | The corrected design closes BF1–BF4 with exact warmup identities, zero-based post-reset ordinals, staged fail-closed reports, and explicit provenance. | v0.1-alpha remains blocked. CLEAR does not make v0.2-alpha beta, implemented, runnable, released, or authorized for execution. | [Final delta rereview](https://github.com/darkside73826779-ship-it/moving-origin-research/blob/76b6b99444f0ecf0f085681c6eddb454f8cf2a60/reviews/critic_m4_final_prescoring_crash_cart_bf1_bf4_rereview.md) |
