...
- RF1–RF2 correction fixes the Phase A peer-projection seal and makes all ten ordered preflight checks mandatory for `PASS`, with omission, duplication, reorder, and `NOT_RUN` rejected.
