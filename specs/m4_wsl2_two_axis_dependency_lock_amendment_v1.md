...
- A byte-identical-replica consumer must stop on `MISMATCH` `[PROPOSED]`. Structural `PASS` does not imply deterministic replica output, equivalence, qualification, scoring fitness, or a scientific claim.
