...
**Active priority work item — CUDA-ready M4 harness with authoritative parallel-CPU L8, Work Item A:** Rebecca re-released the callable-step amendment at `coordinator/m4-item-a-implementation-rerelease` @ `2a38ecc4e389be8c6c698e476cf88d581b0fa280`. TASK BUILDER's IF1-remediated implementation is at `taskbuilder/m4-item-a-implementation` @ `0519f22cd888da1c73e18c5f3bd20b6d50c0e903`, remediation commit `b470241741efe1434e2299bf171957aa51b28021`. Persistent CRITIC returned LAW_FIDELITY CLEAR / IMPLEMENTATION CLEAR at `critic/m4-item-a-if1-rereview` @ `ed799bf9623ed784eff536d1221773eb778a70d8`, artifact `reviews/critic_m4_item_a_if1_rereview.md`; 12/12 tests and independent fail-closed state-preservation checks passed. The ball is with Rebecca for the exact implementation decision. No merge, scoring, seed, real-model, Work Item B, or L8-backend release is included.

**Parallel Principal-directed M4 model-selection work item, Work Item B:** Persistent CRITIC reviewed the TF1–TF4 tokenizer-materialization remediation at `critic/m4-tokenizer-tf1-tf4-rereview` @ `2fea8e071ead56da2c6597727c2af9f01f831643` and returned LAW_FIDELITY CLEAR / SUBSTANTIVE BLOCK. RF1 requires an independently bound immutable `tokenizer_config.json` identity; RF2 and RF3 require exact `type: string` digest constraints and numeric-negative fixtures. The ball is with ARCHITECT for narrow RF1–RF3 remediation, but RF1 is stopped pending committed digest/provenance or bounded derivation authority. Q2 remains unsigned, EF3 remains held, and no tokenizer/model/OCI access, materialization, acquisition, qualification, scoring, seeds, merge, or rung selection is authorized.
