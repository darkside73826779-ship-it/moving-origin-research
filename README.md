...
| M4 final pre-scoring crash cart | Is the full-stack non-scoring dress-rehearsal design internally coherent? | **v0.2-alpha COMBINED CLEAR; not promoted or released** | BF1–BF4 are closed and the blocked v0.1-alpha design remains retained. The corrected design is still alpha: CLEAR does not make it beta, runnable, implemented, or authorized for execution. See the [final delta rereview](https://github.com/darkside73826779-ship-it/moving-origin-research/blob/76b6b99444f0ecf0f085681c6eddb454f8cf2a60/reviews/critic_m4_final_prescoring_crash_cart_bf1_bf4_rereview.md). |
...
- a separate promotion decision, implementation, final executable review, and explicit release of the cleared M4 pre-scoring crash-cart alpha;
