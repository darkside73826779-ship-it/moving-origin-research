...
| M4 final pre-scoring crash cart | Is the full-stack non-scoring dress-rehearsal design internally coherent? | **Beta; implementation authorized, execution prohibited** | BF1–BF4 are independently clear and Rebecca promoted the exact design to implementation beta. The blocked v0.1-alpha remains retained. Beta does not mean runnable, released, scored, or promoted to v1. See the [final delta rereview](https://github.com/darkside73826779-ship-it/moving-origin-research/blob/76b6b99444f0ecf0f085681c6eddb454f8cf2a60/reviews/critic_m4_final_prescoring_crash_cart_bf1_bf4_rereview.md). |
...
- implementation, final executable review, and explicit run release of the M4 pre-scoring crash-cart beta;
